        ...
        if not isDoingAction then
            ...
            Citizen.CreateThread(function ()
                ...
                while isDoingAction do
                    ...
                    if IsControlJustPressed(0, 202) and mythic_action.canCancel then
            ...
            exports['mythic_notify']:SendAlert('error', 'Já estás a fazer algo', 1000)
        end
    else
        exports['mythic_notify']:SendAlert('error', 'Estás morto', 1000)
    end
end
...
function DisableActions(ped)
    ...
    if mythic_action.controlDisables.disableInventory then
