...
menu_optionsCop = {
    {name = "Roupas", f = customiseCop, param = nil},
    {name = "Acessórios", f = accessories, param = nil},
}
player_data  = {
...
local clothing_shops = {
    {name="Clothing Store", id=73, x=77.03, y=-1398.84, z=29.39},
    {name="Clothing Store", id=73, x=456.94, y=-991.17, z=30.69},
}
incircle = false
    ...
    while true do
        ...
        for k,v in ipairs(clothing_shops) do
            if (Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 5.0) then
                letsleep = false
                --DrawMarker(27, v.x, v.y, v.z - 1, 0, 0, 0, 0, 0, 0, 1.0001, 1.0001, 0.5001, 1555, 0, 0,165, 0, 0, 0,0)
                DrawText3Ds(v.x, v.y, v.z+0.5, "[~g~E~w~] mudar de roupa")
