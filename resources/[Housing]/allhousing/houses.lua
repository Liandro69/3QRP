...
--  GarageShell2  = 'shell_garagem',
 ...
 -- Barbers   = 'shell_barber',
  ...
  --Novos Mlo´s
  Armazem1       = "shell_warehouse1",
  ArmazemGrande  = "shell_warehouse2",
  Stash          = "shell_warehouse3",
  Armazem2       = "shell_coke1",
  CokeLab        = "shell_coke2",
  LabdeMeta      = "shell_meth",
  WeedFarm       = "shell_weed2",
  ArmazemGrande2 = "shell_weed",
}
...
ShellOffsets = {
  ...
  --Novos Mlo´s
  Armazem1       = {exit = vector4(9.050, -1.150, 29.00004, 248.150)}, --1256.1025390625,-1976.5089111328,14.303400993347  --1249.716796875,-1980.3638916016,14.303400993347  2.347, -3.952
  ArmazemGrande  = {exit = vector4(12.29147, -5.414795, 28.96133, 270.8702)},
  Stash          = {exit = vector4(-1.758,2.4,28.7,271.0)}, --1236.4688720703,-1980.9326171875,20.113172531128 --1260.2268066406,-1981.8879394531,14.27073764801
  Armazem2       = {exit = vector4(5.797,-7.937,29.102,178.82)}, --OFFSET A SER AJUSTADO  --1241.5775146484,-1983.1574707031,14.700091362 --1241.0382080078,-1979.3208007813,14.700091362
  CokeLab        = {exit = vector4(6.284302, -8.289307, 28.99088, 178.625)},
  LabdeMeta      = {exit = vector4(6.284302, -8.289307, 28.99088, 178.625)},
  WeedFarm       = {exit = vector4(-17.51855, -11.66284, 28.98102, 98.85722)}, --OFFSET A SER AJUSTADO
  ArmazemGrande2 = {exit = vector4(-17.51855, -11.66284, 28.98102, 98.85722)},
--[[
