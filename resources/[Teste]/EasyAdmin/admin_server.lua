		...
		if DoesPlayerHavePermission(source,"easyadmin.screenshot") then
				...
				local disconnect = {
					{
						["color"] = "8663711",
						["title"] = "SCREENSHOT",
						["description"] = "Screenshot from Player ".. getName(playerId,true).." done, "..res.." requested by".. getName(src,true),
						["footer"] = {
							["text"] = communityname,
			...
			repeat
				...
				if timeoutwait == 5 then
					...
					TriggerClientEvent('EasyAdmin:TakeScreenshot', src, "UPLOAD", "FAILED")
				end
