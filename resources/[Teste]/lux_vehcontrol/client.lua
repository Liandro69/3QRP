...
--[[ 							-- First thing
							elseif IsControlJustPressed(1, 158) or IsDisabledControlJustPressed(1, 158) then
								if IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(PlayerPedId(), false), 10) then
								else
									SetVehicleExtra(GetVehiclePedIsUsing(PlayerPedId(), false), 12, true)
									SetVehicleExtra(GetVehiclePedIsUsing(PlayerPedId(), false), 11, true)
									SetVehicleExtra(GetVehiclePedIsUsing(PlayerPedId(), false), 10, false)
									TriggerEvent("lux_vehcontrol:ELSClick", "On", 0.5)
								end
					
							-- First thing
							elseif IsControlJustPressed(1, 157) or IsDisabledControlJustPressed(1, 157) then
								if IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(PlayerPedId(), false), 11) then
								else
										SetVehicleExtra(GetVehiclePedIsUsing(PlayerPedId(), false), 11, false)
										SetVehicleExtra(GetVehiclePedIsUsing(PlayerPedId(), false), 12, true)
										SetVehicleExtra(GetVehiclePedIsUsing(PlayerPedId(), false), 10, true)
										TriggerEvent("lux_vehcontrol:ELSClick", "On", 0.5)
								end
					
							-- First thing
							elseif IsControlJustPressed(1, 160) or IsDisabledControlJustPressed(1, 160) then
								if IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(PlayerPedId(), false), 12) then
								else
									SetVehicleExtra(GetVehiclePedIsUsing(PlayerPedId(), false), 12, false)
									SetVehicleExtra(GetVehiclePedIsUsing(PlayerPedId(), false), 10, true)
									SetVehicleExtra(GetVehiclePedIsUsing(PlayerPedId(), false), 11, true)
									TriggerEvent("lux_vehcontrol:ELSClick", "On", 0.5)
								end ]]	
