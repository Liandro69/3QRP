...
CCTVCamLocations = {
	...
	[25] =  { ['x'] = 438.78,	['y'] = -978.63,	['z'] = 31.65,	['h'] = 229.7, 	['info'] = ' Esquadra Entrada Receção' },
	[26] =  { ['x'] = 441.65,	['y'] = -988.01,	['z'] = 31.65,	['h'] = 31.69, 	['info'] = ' Esquadra Entrada Cadeiras' },
	[27] =  { ['x'] = 433.86,	['y'] = -977.93,	['z'] = 31.65,	['h'] = 109.69, ['info'] = ' Esquadra Entrada Porta' },
	[28] =  { ['x'] = 106.52,	['y'] = -1926.85,	['z'] = 30.59,	['h'] = 145.68, ['info'] = ' Groove Rotunda' },
	[29] =  { ['x'] = -12.58,	['y'] = -1850.06,	['z'] = 30.59,	['h'] = 313.68, ['info'] = ' Groove Parque' },
	[30] =  { ['x'] = 356.70,	['y'] = -2066.27,	['z'] = 30.59,	['h'] = 4.67, 	['info'] = ' Vagos Barrio' },
	[31] =  { ['x'] = -627.28,	['y'] = -239.44,	['z'] = 39.2,	['h'] = 335.85, ['info'] = ' Vangelico 1' },
	[32] =  { ['x'] = -620.2,	['y'] = -224.46,	['z'] = 38.95,	['h'] = 147.98, ['info'] = ' Vangelico 2' },
}
...
AddEventHandler("cctv:camera", function(camNumber)
	...
	if inCam then
		...
		if camNumber > 0 and camNumber < #CCTVCamLocations+1 then
			...
			exports['mythic_notify']:SendAlert('error', "Camera está avariada")
		end
	end
end)
