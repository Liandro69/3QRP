...
local robbableHouses = {
 ...
 --[[ [211] = {x = 430.99, y = -1725.5, z = 29.61, info = 'Roy Lowenstein Blvd 21', copJob = 'police'},
  [212] = {x = 442.72, y = -1706.93, z = 29.49, info = 'Roy Lowenstein Blvd 22', copJob = 'police'},
  [213] = {x = 471.16, y = -1561.47, z = 32.8, info = 'Roy Lowenstein Blvd 23/Apt1', copJob = 'police'},
  [214] = {x = 465.83, y = -1567.54, z = 32.8, info = 'Roy Lowenstein Blvd 23/Apt2', copJob = 'police'},
  [215] = {x = 461.39, y = -1573.95, z = 32.8, info = 'Roy Lowenstein Blvd 23/Apt3', copJob = 'police'},
  [216] = {x = 455.53, y = -1579.34, z = 32.8, info = 'Roy Lowenstein Blvd 23/Apt4', copJob = 'police'},
  [217] = {x = 442.13, y = -1569.43, z = 32.8, info = 'Roy Lowenstein Blvd 23/Apt5', copJob = 'police'},
  [218] = {x = 436.5, y = -1563.9, z = 32.8, info = 'Roy Lowenstein Blvd 23/Apt6', copJob = 'police'},
  [219] = {x = 431.15, y = -1558.66, z = 32.8, info = 'Roy Lowenstein Blvd 23/Apt7', copJob = 'police'}, ]]
  ...
  [297] = {x = 372.04, y = -2055.52, z = 21.75, info = 'Jamestown Street 20/Apt60', copJob = 'police'},
    ...
    ESX.TriggerServerCallback('tqrp_base:getJobsOnline', function(ems, police, sheriff)
      --if police >= 3 then
        ...
        for id,v in pairs(robbableHouses) do
          if v.copJob == 'police' then cops = police else cops = sheriff end
          if cops >= 3 then
...
AddEventHandler('houseRobberies:createHouse', function(id)
 local house = robbableHouses[id]
 TriggerServerEvent('tqrp_base:roblog','Roubo a Casa','Entrou na casa ID: '..id..'\nLocalização: '..house.info, 4289797)
...
-- A FAZER
RegisterNetEvent('houseRobberies:client:search')
AddEventHandler('houseRobberies:client:search', function(id, table)
     ...
     for i=1,#myRobbableItems do
      if (GetDistanceBetweenCoords(generator.x + myRobbableItems[i]["x"], generator.y + myRobbableItems[i]["y"], generator.z + myRobbableItems[i]["z"], GetEntityCoords(PlayerPedId())) < 1.4) and not myRobbableItems[i]['isSearched'] then
       ...
       if IsControlJustReleased(1, 74) then
        ...
        TriggerServerEvent('houseRobberies:server:search', isRobbing, myRobbableItems)
        ...
        exports['mythic_progbar']:Progress({
          ...
          if not status then
            TriggerServerEvent('houseRobberies:searchItem', isRobbing)
          end
        end)
       end
      end
