...
PoliceGarage = function(type)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), "tqrp_AmbulanceGarage_menu",
		{
...
VehicleMenu = function(type)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), "tqrp_AmbulanceGarage_vehicle_garage",
		{
			title    = Config.TitlePoliceGarage,
			align    = "center",
			elements = elements
	...
	function(data, menu)
		menu.close()
		insideMarker = false
		local plate = exports['tqrp_vehicleshop']:GeneratePlate()
