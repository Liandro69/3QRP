...
Config.CarZones = {
	PoliceCarGarage = {
		Pos = {
			{x = 328.9,  y = -558.85, z = 28.74},
			{x = 340.48,  y = -562.66, z = 28.74}
		}
	}
}
...
Config.HeliZones = {
	PoliceHeliGarage = {
		Pos = {
			{x = 350.51,  y = -587.92, z = 74.17},
			{x = 312.86,  y = -1464.93, z = 46.51}
		}
	}
}
...
Config.BoatZones = {
	PoliceBoatGarage = {
		Pos = {
			{x = 3855.93,  y = 4454.61, z = -0.47},
			{x = -725.84,  y = -1326.91, z = -0.47}
		}
	}
}
...
Config.CarGarageColour = 2
Config.CarGarageName = "Garagem Carros S.E.M"
...
Config.HeliGarageColour = 2
Config.HeliGarageName = "Garagem Helicopteros S.E.M"
...
Config.BoatGarageName = "Garagem Barcos S.E.M"
...
Config.ExtraGarageColour = 2
Config.ExtraGarageName = "Garagem Extras S.E.M"
...
Config.CarDraw3DText = "~g~Abre a garagem ~b~[E]"			-- set your desired text here
...
Config.HeliDraw3DText = "~g~Abre a garagem ~b~[E]"		-- set your desired text here
...
Config.BoatDraw3DText = "~g~Abre a garagem ~b~[E]"		-- set your desired text here
...
Config.ExtraDraw3DText = "Pressiona ~g~[E]~s~ para aceder ao ~y~Menu de Extras~s~"		-- set your desired text here

-- Police Cars:
Config.PoliceVehicles = {
	--{ model = '03expeditionr', label = 'FORD EXPORT - RECRUTAS', price = 0 },
	{ model = 'ambulance', label = 'Ambulancia S.E.M', price = 0 },
	{ model = 'pd1.', label = 'Dodge Charger', price = 0 }

}

-- Police Helicopters:
Config.PoliceHelicopters = {
	{ model = 'seasparrow', label = 'S.E.M Seasparrow', livery = 0, price = 0 }
}

-- Police Boats:
Config.PoliceBoats = {
	{ model = 'dinghy', label = 'S.E.M Dinghy', livery = 0, price = 0 }
}
...
Config.VehicleParked = "~b~Veiculo~s~ Foi estacionado!"
Config.NoVehicleNearby = "Sem ~b~Veiculo~s~ por perto!"
Config.CarOutFromPolGar = "Tiras te o ~b~Veiculo~s~ da ~y~Garagem~s~!"
...
Config.VehRepNotify = "O teu ~b~Veiculo~s~ está a ser ~y~reparado~s~, espera!"
Config.VehRepDoneNotify = "O teu ~b~Veiculo~s~ foi ~y~reparado~s~!"
Config.VehCleanNotify = "O teu ~b~Veiculo~s~ está a ser ~y~limpo~s~, por favor espera!"
Config.VehCleanDoneNotify = "O teu ~b~Veiculo~s~ foi ~y~limpo~s~!"
