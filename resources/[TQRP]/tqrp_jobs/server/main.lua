	...
	MySQL.Async.fetchAll('SELECT * FROM warehouses', {}, function(result)
		for i = 1, #result do
			for k,v in pairs(Warehouses) do
				if result[i].storeID == v.storeID then
					v.materials = json.decode(result[i].materials)
				end
			end
		end
	end)
...
function UpdateWarehouse()
	Citizen.Wait(10)
	for k,v in pairs(Warehouses) do
		local jmaterials = json.encode(v.materials)
		MySQL.Async.execute('UPDATE warehouses SET materials = @materials WHERE storeID = @storeID', {['storeID'] = v.storeID, ['materials'] = jmaterials}, function() end)
	end
end
...
Local = {
	addTrailer = "A carga foi carregada com sucesso.",
	removeTrailer = "O descarregamento foi concluido com sucesso.",
	someError  = " ocorreu um erro.",
	get = "Conseguiste ",
	lingot_carbon = "Carvão processado",
	lingot_iron = "um lingote de ferro",
	lingot_silver = "um lingote de prata",
	lingot_gold = "um lingote de ouro",
	youNeed10 = "Sinto muito, mas estás a perder mercadoria, precisas de pelo menos 20 peças.",
	pine_processed  = 'Madeira processada',
	youNeedASeed = "Necesitas de uma semente desse tipo",
	noMoney = "Não tens dinheiro suficiente",
	youBought = "Compraste um objeto",
	removeSalinity = "Tiraste os aditivos da vinha",
	removePollution = "Retiraste a contaminação da vinha",
	addChemists = "Adicionaste químicos ao solo",
	addSalinity = "Adicionaste aditivos ao solo",
	addPollution = "Adicionaste contaminação ao solo",
	noBottles = "Não tens uvas pra lavar",
	goodWashing = "Limpaste as uvas",
	noPieces = "Não tens peças suficientes",
	goodPackage = "Empacotaste tudo corretamente",
	youDontHaveEnough = "Não tens material suficiente.",
	goodWarehouse = "Vendeste corretamente todo o material",
	youWin = "Ganhaste dinheiro",
	fillwarehouse = "Enche o armazém"
}
...
Config = {}
Config.Rocks = {
    {x = 2972.36, y = 2775.44, z = 39.24, health = 10, data = "carbon", max = 20},
    {x = 2968.64, y = 2775.64, z = 39.48, health = 10,  data = "iron", max = 20},
    {x = 2964.44, y = 2773.96, z = 40.04, health = 10, data = "carbon", max = 20},
    {x = 2951.16, y = 2768.52, z = 39.84, health = 10,  data = "iron", max = 20},
    {x = 2947.2, y = 2765.96, z = 40.36, health = 10, data = "iron", max = 20},
    {x = 2937.2, y = 2771.92, z = 39.88, health = 10, data = "carbon", max = 20},
    {x = 2927.28, y = 2792.41, z = 40.49, health = 10, data = "gold", max = 20},
    {x = 2925.56, y = 2796.48, z = 41.44, health = 10, data = "iron", max = 20},
    {x = 2921.44, y = 2799.32, z = 42.16, health = 10, data = "iron", max = 20},
    {x = 2938.52, y = 2812.64, z = 43.4, health = 10, data = "gold", max = 20},
    {x = 2951.32, y = 2816.32, z = 42.92, health = 10, data = "carbon", max = 20},
    {x = 2971.96, y = 2798.68, z = 42.16, health = 10, data = "iron", max = 20},
    {x = 2979.08, y = 2790.48, z = 41.6, health = 10, data = "iron", max = 20}
}
Config.Woods = {
...
Config.WaterPoints = {
	{id = 1, x = -1844.78, y = 2177.77, z = 108.4, salinity = 100, chemists = 100, pollution = 0},
	{id = 2, x = -1849.57, y = 2178.56, z = 108.4, salinity = 0, chemists = 100, pollution = 100},
	{id = 3, x = -1854.26, y = 2179.32, z = 109.51, salinity = 0, chemists = 100, pollution = 100},
	{id = 4, x = -1859.01, y = 2180.19, z = 110.37, salinity = 0, chemists = 100, pollution = 100},
	{id = 5, x = -1835.5, y = 2176.05, z = 107.68, salinity = 100, chemists = 0, pollution = 100}
}
Config.Valves = {
	{id = 1, type = "salinity", quantity = 25, seconds = 60, x = -1932.21, y = 2038.94, z = 140.83, name = "electricityDown", isAvaliable = true, animSeconds = 10, anim = 'WORLD_HUMAN_HAMMERING'},
	...
	{id = 3, type = "pollution", quantity = 100, seconds = 300, x = -1856.82, y = 2061.37, z = 141.01, name = "greenpeaceAcept", isAvaliable = true, animSeconds = 10, anim = {lib = "anim@amb@nightclub@mini@dance@dance_solo@female@var_b@", anim = "high_center"}},
	...
	{id = 5, type = "chemists", quantity = 50, seconds = 150, x = -1926.75, y = 2059.4, z = 140.84, name = "toxic1", isAvaliable = true, animSeconds = 10, anim = {lib = "mini@repair", anim = "fixing_a_ped"}},
	{id = 6, type = "salinity", quantity = -25, seconds = 600, x = -1821.31, y = 2382.93, z = 29.81, name = "salinity1", isAvaliable = true, animSeconds = 10, anim = 'WORLD_HUMAN_CONST_DRILL'},
	{id = 7, type = "salinity", quantity = 50, seconds = 150, x = -1630.18, y = 2348.84, z = 39.34, name = "salinity2", isAvaliable = true, animSeconds = 10, anim = 'WORLD_HUMAN_GARDENER_LEAF_BLOWER'},
	{id = 8, type = "pollution", quantity = 30, seconds = 150, x = -1900.84, y = 2083.51, z = 150.03, name = "pollution1", isAvaliable = true, animSeconds = 10, anim = 'WORLD_HUMAN_BINOCULARS'},
	{id = 9, type = "pollution", quantity = -40, seconds = 600, x = -1592.87, y = 2398.39, z = 24.5 , name = "pollution2", isAvaliable = true, animSeconds = 10, anim = 'WORLD_HUMAN_BUM_WASH'},
	{id = 10, type = "chemists", quantity = 50, seconds = 150, x = -1561.33, y = 2283.75, z = 50.85 , name = "chemist1", isAvaliable = true, animSeconds = 10, anim = 'WORLD_HUMAN_YOGA'},
	{id = 11, type = "pollution", quantity = 25, seconds = 150, x = -1620.89, y = 2366.3, z = 37.34 , name = "pollution3", isAvaliable = true, animSeconds = 10, anim = 'WORLD_HUMAN_WELDING'},
...
Config.CycleGrowSeconds =4
Config.CycleWaterSeconds = 14

Config.BasePrices = {
 	bottleWater_package = 112,
 	blueberry_package = 42,
 	tomato_package = 42,
 	lingot_carbon = 30,
 	lingot_iron =30,
 	lingot_silver = 30,
...
AddEventHandler('tm1_stores:addTrailer', function(plate, tons)
	if X.AddTrailer(plate, tons) == true then
		...
		exports['mythic_notify']:SendAlert('inform',source, Local.addTrailer)
	else
...
AddEventHandler('tm1_stores:giveMineral', function(mineral)
	local xPlayer  = ESX.GetPlayerFromId(source)
	if xPlayer.canCarryItem(mineral.."_piece", 5)	then
		xPlayer.addInventoryItem(mineral.."_piece", 5)
	else
		TriggerClientEvent('mythic_notify:client:SendAlert', source, {type = 'error', text = "Não tens espaço suficiente", length = 5500})
	end
end)
...
AddEventHandler('tm1_stores:craft',function(item)
	...
	if xPlayer then
		...
		if quantityMineral.count >= 10 then
			if xPlayer.canCarryItem("lingot_"..item,5)	then
				xPlayer.removeInventoryItem(item.."_piece",10)
				xPlayer.addInventoryItem("lingot_"..item,5)
			else
				TriggerClientEvent('mythic_notify:client:SendAlert', source, {type = 'error', text = "Não tens espaço suficiente", length = 5500})
			...
			TriggerClientEvent('mythic_notify:client:SendAlert', source, {type = 'error', text = "Precisas de mais mercadoria para processar", length = 5500})
		end
	end
end)
...
AddEventHandler('tm1_stores:giveWood', function(wood)
	local xPlayer  = ESX.GetPlayerFromId(source)
	if xPlayer then
		if xPlayer.canCarryItem(wood.."_wood", 6)	then
			xPlayer.addInventoryItem(wood.."_wood", 6)
		else
			TriggerClientEvent('mythic_notify:client:SendAlert', source, {type = 'error', text = "Não tens espaço suficiente", length = 5500})
		end
	end
...
AddEventHandler('tm1_stores:craftWood',function(item)
	...
	if xPlayer then
		...
		if quantityWood.count >= 20 then
			if xPlayer.canCarryItem(item.."_processed",4)	then
				xPlayer.removeInventoryItem(item.."_wood",20)
				xPlayer.addInventoryItem(item.."_processed",4)
			else
				TriggerClientEvent('mythic_notify:client:SendAlert', source, {type = 'error', text = "Não tens espaço suficiente", length = 5500})
...
AddEventHandler('tm1_stores:package',function(from,to)
	...
	if xPlayer then
		...
		if totalPieces >= 10 then
			if xPlayer.canCarryItem(to,totalPieces / 10) then
...
X.SetMaterial = function(warehouse, material, quantity)
	if quantity > 0 and X.IsAValidMaterial(material) and X.IsAValidWarehouse(warehouse) then
		for i,v in pairs(Warehouses) do
			if v.storeName == warehouse or v.storeID == warehouse then
				if quantity <= v.maxMaterials[material] then
