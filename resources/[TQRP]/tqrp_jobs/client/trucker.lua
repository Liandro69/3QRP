	...
	ESX.TriggerServerCallback('tm1_stores:getWarehouse', function(warehouse)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'warehouse', {
			...
			if data.current.value == "infoTrucks" then
				TriggerEvent("pNotify:SendNotification", {text = "<span style='font-weight: 300'>" .. Local.haveToBuy .. "</span>",
					layout = "topRight",
					timeout = 2000,
					progressBar = false,
					type = "success",
				...
				TriggerEvent("pNotify:SendNotification", {text = "<span style='font-weight: 300'>" .. msg .. "</span>",
					layout = "topRight",
					timeout = 2000,
					progressBar = false,
					type = "success",
