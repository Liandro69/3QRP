...
Config.Documents['br'] = {
      ["public"] = {
        ...
        {
          headerTitle = "FORMULÁRIO DE CONINHAS",
          headerSubtitle = "Forma de dizer que sou coninhas.",
          elements = {
            { label = "CONTEÚDO DE AFIRMAÇÃO", type = "textarea", value = "", can_be_emtpy = false },
          }
        },
      ...
      ["police"] = {
        ...
        {
          headerTitle = "AUTORIZAÇÃO DE PORTE DE ARMA",
      ...
      ["mechanic"] = {
        {
          headerTitle = "LICENÇA DE REPARO E MODIFICAÇÃO MECÂNICA",
          headerSubtitle = "Licença especial para reparo e modificação de veículos.",
          elements = {
            { label = "TITULAR NOME", type = "input", value = "", can_be_emtpy = false },
            { label = "TITULAR SOBNOME", type = "input", value = "", can_be_emtpy = false },
            { label = "VÁLIDO ATÉ", type = "input", value = "", can_be_empty = false },
            { label = "INFORMAÇÃO", type = "textarea", value = "O CIDADÃO AFORMAMENCIADO FOI CONCEDIDO A PERMISSÃO PARA REPARAR, MODIFICAR, E CRIAR ENGENHOS MECÂNICOS VÁLIDA ATÉ A DATA DE VENCIMENTO PREVISTA.", can_be_emtpy = false },
          }
        }
      },
      ["ambulance"] = {
        ...
        {
          headerTitle = "AUTORIZAÇÃO DE USO DE DROGAS",
          headerSubtitle = "Licença oficial de uso de drogas medicinal para os cidadãos.",
          elements = {
            { label = "SEGURADO NOME", type = "input", value = "", can_be_emtpy = false },
            { label = "SEGURADO SOBNOME", type = "input", value = "", can_be_emtpy = false },
            { label = "VÁLIDO ATÉ", type = "input", value = "", can_be_empty = false },
