...
RegisterServerEvent('tqrp_identity:setIdentity')
AddEventHandler('tqrp_identity:setIdentity', function(data, myIdentifiers)
	setIdentity(myIdentifiers.steamid, data, function(callback)
		if callback then
			TriggerClientEvent('tqrp_identity:identityCheck', myIdentifiers.playerid, true)
		else
...
AddEventHandler('es:playerLoaded', function(source)
	...
	TriggerClientEvent('tqrp_identity:saveID', source, myID)
	getIdentity(source, function(data)
		if data.firstname == '' then
			TriggerClientEvent('tqrp_identity:identityCheck', source, false)
			TriggerClientEvent('tqrp_identity:showRegisterIdentity', source)
		else
			TriggerClientEvent('tqrp_identity:identityCheck', source, true)
			Citizen.Wait(28000)
...
AddEventHandler('onResourceStart', function(resource)
	if resource == GetCurrentResourceName() then
		...
		for i=1, #xPlayers, 1 do
			...
			TriggerClientEvent('tqrp_identity:saveID', xPlayer.source, myID)

			getIdentity(xPlayer.source, function(data)
				if data.firstname == '' then
					TriggerClientEvent('tqrp_identity:identityCheck', xPlayer.source, false)
					TriggerClientEvent('tqrp_identity:showRegisterIdentity', xPlayer.source)
				else
					TriggerClientEvent('tqrp_identity:identityCheck', xPlayer.source, true)
				end
			end)
		end
	end
