Config = {
    ...
    -- NOte this might cause an issue of the image getting stuck on peoples screens
        ...
        MenuImage = "https://i.imgur.com/MTgd0JO.png",
    ...
    Config.Languages = {
      ['en'] = {
            ['emotes'] = 'Animações',
            ['danceemotes'] = "🕺 Animações Dança",
            ['propemotes'] = "📦 Animações com Props",
            ['favoriteemotes'] = "🌟 Favoritos",
            ['favoriteinfo'] = "Adiciona uma animação aos favoritos",
            ['rfavorite'] = "Apagar animação dos favoritos",
            ['prop2info'] = "❓ Animações com props encontram-se no fim",
            ['set'] = "Definir (",
            ['setboundemote'] = ") como animação rápida ?",
            ['newsetemote'] = "~w~ é agora uma animação rápida, pressiona ~g~CapsLock~w~ para o usares.",
            ['cancelemote'] = "Cancelar Animação",
            ['cancelemoteinfo'] = "~r~X~w~ Cancelar ",
            ['walkingstyles'] = "Formas de Caminhar",
            ['resetdef'] = "Apagar preferências",
            ['normalreset'] = "Normal (Reset)",
            ['moods'] = "Estados de espírito",
            ['infoupdate'] = "Informação",
            ['infoupdateav'] = "Informação (Update available)",
            ...
            ['notvaliddance'] = "é uma dança inválida.",
            ['notvalidemote'] = "não é uma animação válida.",
            ['nocancel'] = "Não há animação para cancelar.",
            ['maleonly'] = "Esta animação é só para homens, desculpa!",
            ['emotemenucmd'] = "Faz /emotemenu para acederes ao menu.",
            ['shareemotes'] = "👫 Animações Partilhadas",
            ['shareemotesinfo'] = "Convidar a pessoa mais perto para a animação",
            ['sharedanceemotes'] = "🕺 Danças Partilhadas",
            ['notvalidsharedemote'] = "não é uma animação partilhada válida.",
            ['sentrequestto'] = "Enviaste o pedido para ~y~",
            ['nobodyclose'] = "Ningúem ~r~perto~w~ o suficiente.",
            ['doyouwanna'] = "~y~Y~w~ para aceitar, ~r~L~w~ para recusar (~g~",
            ['refuseemote'] = "Animação recusada.",
            ['makenearby'] = "faz com que o jogador perto faça animação",
            ['camera'] = "Pressiona ~y~G~w~ para tirar foto.",
            ['makeitrain'] = "Pressiona ~y~G~w~ para largar nota.",
            ['pee'] = "Mantém pressionado ~y~G~w~ para mijar.",
            ['spraychamp'] = "Mantém pressionado ~y~G~w~ para mandar champagne.",
            ['bound'] = "Definida ",
            ['to'] = "no",
            ['currentlyboundemotes'] = " Animações de acesso rápido: ",
            ['notvalidkey'] = "não é uma tecla válida.",
            ['keybinds'] = "🔢 Teclas de Acesso Rápido",
            ['keybindsinfo'] = "Usar"
      },
      ['fr'] = {
            ['emotes'] = 'Emotes',
