...
RegisterServerEvent('tqrp_accessories:pay')
AddEventHandler('tqrp_accessories:pay', function()
...
RegisterServerEvent('tqrp_accessories:save')
AddEventHandler('tqrp_accessories:save', function(skin, accessory)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)

	TriggerEvent('tqrp_datastore:getDataStore', 'user_' .. string.lower(accessory), xPlayer.identifier, function(store)
...
ESX.RegisterServerCallback('tqrp_accessories:get', function(source, cb, accessory)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('tqrp_accessories:checkMoney', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
