...
AddEventHandler('tqrp_phone:shared:ComponentsReady', function()
    ...
    Callbacks:RegisterServerCallback('tqrp_phone:server:GetBankTransactions', function(source, data, cb)
    ...
    Callbacks:RegisterServerCallback('tqrp_phone:server:Transfer', function(source, data, cb)
    ...
    Callbacks:RegisterServerCallback('tqrp_phone:server:MazePay', function(source, data, cb)
