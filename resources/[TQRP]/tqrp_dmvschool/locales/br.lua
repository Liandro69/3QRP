Locales['br'] = {
  ...
  ['drive_truck'] = 'teste de habilidades de caminhão',
  ['school_item'] = '$%s',
  ['driving_school'] = 'escola de condução (Aberta)',
  ...
  ['driving_too_fast'] = 'Aviso de Velocidade! Limite: %s km/h!',
  ['errors'] = 'erros: %s/%s',
  ['you_damaged_veh'] = 'Aviso de estragos!',
}
