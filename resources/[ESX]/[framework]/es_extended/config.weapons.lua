Config.Weapons = {
...

	{
		...
		label = _U('weapon_marksmanrifle'),
		components = {
			{name = 'Tracer', label = _U('component_clip_default'), hash = GetHashKey('COMPONENT_PISTOL_MK2_CLIP_TRACER')},
			...
			{name = 'Suppressor', label = _U('component_Suppressor'), hash = GetHashKey('COMPONENT_AT_PI_SUPP_02')},
			{name = 'yusuf', label = _U('component_luxary_finish'), hash = GetHashKey('COMPONENT_PISTOL_MK2_CAMO_05')}
		}
	},
