function CreateExtendedPlayer(player, accounts, inventory, job, loadout, name, coords)
	...
	self.addMoney = function(money)
		...
		if money >= 0 then
			...
			TriggerClientEvent('conde-inventoryhud:notification',self.source, "cash", "Dinheiro", money, false)
		end
	end
	...
	self.removeMoney = function(money)
		...
		if money > 0 then
			...
			TriggerClientEvent('conde-inventoryhud:notification',self.source, "cash", "Dinheiro", money, true)
		end
	end
	...
	self.addWeapon = function(weaponName, ammo)
		if not self.hasWeapon(weaponName) then
			...
			TriggerClientEvent('conde-inventoryhud:notification', self.source, weaponName, weaponLabel, 1, false)
		end
	end
	...
	self.removeWeapon = function(weaponName, ammo)
		...
		if weaponLabel then
			...
			TriggerClientEvent('conde-inventoryhud:notification', self.source, weaponName, weaponLabel, 1, true)
		end
	end
