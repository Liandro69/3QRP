...
AddEventHandler('tqrp_datastore:getDataStore', function(name, owner, cb)
	cb(GetDataStore(name, owner))
end)

AddEventHandler('tqrp_datastore:getDataStoreOwners', function(name, cb)
	cb(GetDataStoreOwners(name))
end)

AddEventHandler('tqrp_datastore:getSharedDataStore', function(name, cb)
